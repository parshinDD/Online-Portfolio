export const profile = {
    ...
    greeting: 'Привет, я',
    pitch: 'Студент 3 курса ПГНИУ (ПМИ, совместно с МФТИ). Разбираюсь в бэкенде, машинке и системном программировании. Если жизнь - это вызов, я перезвоню.',
...
export const timeline = [
    ...
    },
    {
        ...
        title: 'Teamlead на Faunistica 3.0',
